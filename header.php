...
jQuery(function($) {
  ...
  // $('<div class="owl-carousel" id="carousel' + i + '"></div>').appendTo('.slider');
            // $('.tester').each(function(i) {
            //     $('<div class="owl-carousel" id="carousel' + i + '"></div>').appendTo('.slider');
            //     $(this).find('.wrapper').each(function(j) {
            //         $(this).appendTo('#carousel' + j);
            //     });
            //     $(this).hide();
            // });
...
// 				 if (e.item.index + 1 === e.item.count) {
//  console.log( "woof");
//  				$('.owl-stage').unmousewheel();
// 						$('.owl-stage').bind("mousewheel", function() {
//     return false;
// });
// 				 }
//      });
...
<!-- <div class="tester" id="pleasework" style="width:50px; height:100px; background:blue;">
